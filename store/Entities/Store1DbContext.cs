...
public partial class Store1DbContext : DbContext
{
    public Store1DbContext()
    {
    }

    public Store1DbContext(DbContextOptions<henrystoreContext> options)
        : base(options)
    {
    }
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasMany(d => d.CommentsNavigation)
                ...
                .UsingEntity<Dictionary<string, object>>(
                    "Reaction",
                    l => l.HasOne<Comment>().WithMany().HasForeignKey("CommentId")
                        .HasConstraintName("fk_reaction_comment"),
                    r => r.HasOne<Customer>().WithMany().HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("fk_reaction_customer"),
                    j =>
                    {
